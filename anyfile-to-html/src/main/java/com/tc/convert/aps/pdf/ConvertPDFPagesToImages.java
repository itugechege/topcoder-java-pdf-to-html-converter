...
public class ConvertPDFPagesToImages {
    private static final Logger LOGGER = LoggerFactory.getLogger(ConvertPDFPagesToImages.class);

    public static void main(String[] args) {
        try {
            String sourceDir = "input/VeryComplex/Complex1.pdf"; // Pdf files are read from this folder
            String destinationDir = "output/Complex1/"; // converted images from pdf document are saved here
